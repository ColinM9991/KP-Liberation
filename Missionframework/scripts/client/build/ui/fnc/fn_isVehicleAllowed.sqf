...
if (((_className isKindOf "Plane") && (KPLIB_plane_count >= KPLIB_plane_slots))
    || ((_className isKindOf "Helicopter") && (KPLIB_heli_count >= KPLIB_heli_slots))) exitWith { false };

// Is there an air vehicle building nearby
if (!KPLIB_b_airControl_near) exitWith { false };
